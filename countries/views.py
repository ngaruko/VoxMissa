...
def country(request, country):
    countryObj = Country(code=country)
    # print('code' + country)
    country = [country for country in  Countries() if country.code ==country]
    policies = Policy.objects.all()
    candidates = Profile.objects.all()
    programs = Project.objects.all()
    context = {'country': countryObj, 'policies': policies, 'projects': programs, 'profiles':candidates, 'countries':Countries()}
